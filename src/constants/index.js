import { 
  c, python, java, cpp, javascript, Typescript, Next, html, css, reactjs, tailwind, nodejs, git, edunet, weatherpedia,
  termpw, payloadmaster, threejs, mhft, sketcher, mathwork, CompileVortex, eduskill,
  // ********** My assests
    bgPhoto, bgPhoto2, bgPhoto3, bgPhoto4, bgPhoto5, bgPhoto6, bgPhoto7, bgPhoto8, bgPhoto9, bgPhoto10,
    icon1, icon2, icon3, icon4, icon5, icon6, icon7, icon8, icon9, gitHub, faceBook, whatsApp, gmail,
  // ********** My assests
} from "../assets";
...
export const services = [
  { title: "Javascript", icon: javascript }, { title: "Typescript", icon: Typescript }, { title: "Next.JS", icon: Next },
  { title: "React", icon: reactjs }, { title: "HTML", icon: html }, { title: "CSS", icon: css },
];
// * ############# end services
// * ############# start technologies *
